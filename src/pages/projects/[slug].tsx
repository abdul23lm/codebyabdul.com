...
const ProjectsDetailPage: NextPage<ProjectsDetailPageProps> = ({ project }) => {
  ...
  const canonicalUrl = `https://codebyabdul.com/project/${project?.slug}`;

  return (
    <>
      <NextSeo
        title={`${project?.title} - Project Abdul Latif Munjiat`}
        ...
        openGraph={{
          ...
          siteName: 'Blog Abdul Latif Munjiat',
        }}
      />
